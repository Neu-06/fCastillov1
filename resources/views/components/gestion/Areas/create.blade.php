<form action="{{ route('area.store') }}" method="POST" class="space-y-6">
    @csrf
    <div class="bg-white px-10 py-8 rounded-xl shadow-md max-w-sm mx-auto">
        <div class="space-y-4">
            <h1 class="text-center text-2xl font-semibold text-gray-700 mb-4">Registrar Nueva Area</h1>
            <div>
                <label for="nombre_area" class="block mb-1 text-gray-600 font-semibold">Nombre de Area</label>
