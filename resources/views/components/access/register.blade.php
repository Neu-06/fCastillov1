<div class="h-auto flex justify-center mt-5">
    ...
    <div class="flex w-wLR">
        <div class="w-full p-4">
            <form action="{{ route('cliente.store') }}" method="POST" class="bg-white rounded-md shadow-2xl p-5">
                @csrf
                ...
                <div class="flex items-center border-2 mb-4 py-2 px-3 rounded-2xl">
                    ...
                    <input id="nombre_cliente" class="pl-2 w-full outline-none border-none" type="text" name="nombre_cliente"
                ...
                <div class="flex items-center border-2 mb-4 py-2 px-3 rounded-2xl">
                    ...
                    <input id="apellidos_cliente" class="pl-2 w-full outline-none border-none" type="text" name="apellido_cliente"
                ...
                <div class="flex items-center border-2 mb-4 py-2 px-3 rounded-2xl">
                    ...
                    <input id="correo_cliente" class="pl-2 w-full outline-none border-none" type="email" name="correo_cliente"
                ...
                <div class="flex items-center border-2 mb-4 py-2 px-3 rounded-2xl">
                    ...
                    <input id="telefono_cliente" class="pl-2 w-full outline-none border-none" type="text" name="telefono_cliente"
                ...
                <div class="flex items-center border-2 mb-4 py-2 px-3 rounded-2xl">
                    ...
                    <input id="direccion_cliente" class="pl-2 w-full outline-none border-none" type="text" name="direccion_cliente"
                ...
                <div class="flex items-center border-2 mb-6 py-2 px-3 rounded-2xl ">
                    ...
                    <input class="pl-2 w-full outline-none border-none" type="password" name="password_cliente"
