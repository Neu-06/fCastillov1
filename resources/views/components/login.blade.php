    ...
    <div class="flex w-max">
        <div class="w-full px-8 md:px-32 lg:px-24">
            <form class="bg-white rounded-md shadow-2xl p-5">
                <h1 class="text-tBlack text-center font-bold text-2xl py-6">Iniciar Sesion</h1>
                ...
                <div class="flex justify-between mt-4">
                    <a href="#"
                        class="text-sm ml-2 text-tLink cursor-pointer hover:-translate-y-1 duration-500 transition-all">
