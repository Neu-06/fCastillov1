 <div class="hidden md:flex z-10 md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
     ...
     <nav :class="{ 'flex': open, 'hidden': !open }">
         <x-header.elementosNav.optionNav  textColor="text-tWhite" texto="Gestionar" display="absolute">
         ...
         <x-header.elementosNav.optionNav textColor="text-tWhite" texto="Categorías" display="absolute">
