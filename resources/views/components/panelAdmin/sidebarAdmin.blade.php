        ...
        <div>
            ...
            <nav class="flex flex-col mt-4 gap-1 mx-4">
                ...
                <x-header.elementosNav.optionNav texto="Gestionar" display="static">
                    <x-header.elementosNav.optionSecundario link="{{ route('administrador.gestionarUsuario') }}"
                        texto="Gestionar Usuarios" />
                    <x-header.elementosNav.optionSecundario link="{{ route('roles.index') }}" texto="Gestionar Roles" />
                    <x-header.elementosNav.optionSecundario link="/" texto="Gestionar Clientes" />
