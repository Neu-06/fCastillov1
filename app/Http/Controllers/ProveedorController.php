...
class ProveedorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => 'nullable|email|max:100|unique:proveedors,email',
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            'nombre' => 'required|string|max:255',
            'telefono' => 'required|string|max:20|unique:proveedors,telefono,' . $id . ',id_proveedor',
            'email' => 'nullable|email|max:100|unique:proveedors,email,' . $id . ',id_proveedor',
            'direccion' => 'nullable|string|max:255',
        ]);
